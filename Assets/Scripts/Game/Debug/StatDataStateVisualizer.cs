...
namespace Game.Debug
{
    public class StatDataStateVisualizer : MonoBehaviour
    {
        ...
        public void Init(IStatData isd)
        {
            ...
            //        floatStatData.OnValueChanged += FloatStatData_OnFloatValueChanged;
            ...
            //        intStatData.OnValueChanged += IntStatData_OnIntValueChanged;
            //        IntStatData_OnIntValueChanged(intStatData, 0);
            //        break;
            //    case FloatModifiableStatData floatModifiableStatData:
            //        floatModifiableStatData.OnValueChanged += FloatModifiableStatData_OnFloatValueChanged;
        ...
        //private void IntStatData_OnIntValueChanged(IValueCallback arg1, int arg2)
        //{
        //    _statStateText.text = $"value: {arg1.Value}";
        //}
