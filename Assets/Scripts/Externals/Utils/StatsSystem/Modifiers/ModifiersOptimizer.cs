...
{
    public class ModifiersOptimizer
    {
        ...
        public ModifiersOptimizer()
        {

        }

        public ModifiersOptimizer(long flatData, long multData)
        {
            _flat = flatData;
            _mult = multData;
        }
        ...
        public static ModifiersOptimizer FromBytes(System.Memory<byte> mem, int index)
        {
            var x = mem.Slice(index, 16).Span;
            long flat = System.BitConverter.ToInt64(x);
            long mult = System.BitConverter.ToInt64(x[8..]);
            return new ModifiersOptimizer(flat, mult);
        }
