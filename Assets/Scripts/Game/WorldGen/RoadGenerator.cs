...
namespace Systems.WorldGen
{
    ...
    {
        [System.Serializable]
        private class BoundedItemWithChance<T> : IRandomItem<T>
        ...
        [System.Serializable]
        private class GeneratorLayer<T> where T : Component, ISquareBoundedItem
        {
            [SerializeField, NonReorderable] private BoundedItemWithChance<T>[] _items;
            [SerializeField, MinMax(0, 10)] private Vector2 _amount = new Vector2Int(4, 8);


            public BoundedItemWithChance<T>[] Items => _items;
        ...
        [SerializeField] private BoundedItemWithChance<SquareBoundedItemDefault>[] _predefinedBlocks;
        ...
        [SerializeField] private GeneratorLayer<SquareBoundedItemDefault> _miscsLayer;
        [SerializeField] private GeneratorLayer<SquareBoundedItem<InteractableItem>> _interactablesLayer;
        ...
        private void OnValidate()
        {
            if (_sortInteractables)
            {
                ...
                Array.Sort(_interactablesLayer.Items, (x, y) => x.Item.Prefab.GoodnesValue
                .CompareTo(y.Item.Prefab.GoodnesValue));
            }
        ...
        private void Start()
        {
            ...
            _miscsMap = RandomHelpers.GetRandomMap(_miscsLayer.Items);
            _interactablesMap = RandomHelpers.GetRandomMap(_interactablesLayer.Items);
        ...
        public void GenerateBlock()
        {
            ...
            GenerateItems<BoundedItemWithChance<SquareBoundedItemDefault>,
              SquareBoundedItemDefault>(content, blockTr, y,
              _miscsLayer.Amount, _miscsLayer.Items, _miscsMap, _miscsRandom, _positionsRandom,
              null, true);

            GenerateItems<BoundedItemWithChance<SquareBoundedItem<InteractableItem>>,
              SquareBoundedItem<InteractableItem>>(content, blockTr, y,
              _interactablesLayer.Amount, _interactablesLayer.Items, _interactablesMap,
        ...
        public IEnumerator GenerateBlockCoroutine()
        {
            ...
            var co = StartCoroutine(GenerateItemsCoroutine<BoundedItemWithChance<SquareBoundedItemDefault>,
              SquareBoundedItemDefault>(content, blockTr, y,
              _miscsLayer.Amount, _miscsLayer.Items, _miscsMap, _miscsRandom, _positionsRandom,
              null, true));
            ...
            co = StartCoroutine(GenerateItemsCoroutine<BoundedItemWithChance<SquareBoundedItem<InteractableItem>>,
              SquareBoundedItem<InteractableItem>>(content, blockTr, y,
              _interactablesLayer.Amount, _interactablesLayer.Items, _interactablesMap,
              _interactablesRandom, _positionsRandom, _interactablesGoodChanceCurve,
              false));
        ...
        public async Task GenerateBlockAsync()
        {
            ...
            await GenerateItemsAsync<BoundedItemWithChance<SquareBoundedItemDefault>,
              SquareBoundedItemDefault>(content, blockTr, y,
              _miscsLayer.Amount, _miscsLayer.Items, _miscsMap, _miscsRandom, _positionsRandom,
              null, true);

            await GenerateItemsAsync<BoundedItemWithChance<SquareBoundedItem<InteractableItem>>,
              SquareBoundedItem<InteractableItem>>(content, blockTr, y,
              _interactablesLayer.Amount, _interactablesLayer.Items, _interactablesMap,
              _interactablesRandom, _positionsRandom, _interactablesGoodChanceCurve,
              false);
        ...
        private void GenerateItems<T, T1>(List<GameObject> content, Transform blockTr, float y,
            ...
            where T : BoundedItemWithChance<T1>
